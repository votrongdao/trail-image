 ...
 * @param {function} getPhotos Method to get photos for the post
 * @param {function} getInfo Method to get informatoin for the post
 * @param {boolean} [chronological = true] Whether set photos occurred together at a point in time
 * @returns {Post|Object}
 */
function make(flickrSet, getPhotos, chronological = true) {
   const p = {
      id: flickrSet.id,
